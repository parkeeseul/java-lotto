...
public class Application {
    public static void main(String[] args) {
        ...
        String bonusBallValue = inputView.getBonusBallNumber();

        LottoCalculator lottoCalculator = new LottoCalculator(new WinningLotto(new Lotto(lastWeekLottoValue), bonusBallValue), lottoBuyer.getLottos());
